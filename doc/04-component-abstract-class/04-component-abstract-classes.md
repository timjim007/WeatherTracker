...
- I changed my design from a general weather component to a WeatherTracker component.
- I updated all kernel methods and enhanced methods and wrote their contracts
- I implemented the enhanced method in the secondary class with the kernel methods
- I changed the representation of $this to a Map
- The map represention is {(location,{(key,value)})} where key is (temperature,humidity,windSpeed, precipitation ,condition) and value is the number or string associated with the key.
